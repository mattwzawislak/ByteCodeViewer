...
public class ByteCodeUtils {
     ...
     * <ul>
     * <li>{@link ByteCodeUtils#ACCESS_PRIVATE}
     * <li>{@link ByteCodeUtils#ACCESS_PROTECTED}
     * </ul>
     *
     * @see ByteCodeUtils#isPublic(int)
     */
     ...
     * The list of other visibility access flags are:
     * <ul>
     * <li>{@link ByteCodeUtils#ACCESS_PUBLIC}
     * <li>{@link ByteCodeUtils#ACCESS_PROTECTED}
     * </ul>
     *
     * @see ByteCodeUtils#isPrivate(int)
     */
     ...
     * </ul>
     *
     * @see ByteCodeUtils#isProtected(int)
     */
     ...
     * declarations.
     *
     * @see ByteCodeUtils#isStatic(int)
     */
     ...
     * ignored.
     *
     * @see ByteCodeUtils#isSynchronized(int)
     */
     ...
     *
     * @see ByteCodeUtils#isBridge(int)
     */
     ...
     * ignored.
     *
     * @see ByteCodeUtils#isVolatile(int)
     */
     ...
     * ignored.
     *
     * @see ByteCodeUtils#isTransient(int)
     */
     ...
     * <code>String</code> representation.
     *
     * @see ByteCodeUtils#isVarargs(int)
     */
     ...
     * ignored.
     *
     * @see ByteCodeUtils#isNative(int)
     */
     ...
     * {@link ByteCodeUtils#ACCESS_ABSTRACT}
     * keyword. This will only be present in the class access flags.
     * Otherwise it is ignored.
     *
     * @see ByteCodeUtils#isInterface(int)
     */
     ...
     *
     * @see ByteCodeUtils#isStrict(int)
     */
     ...
     *
     * @see ByteCodeUtils#isSynthetic(int)
     */
     ...
     * it is ignored.
     *
     * @see ByteCodeUtils#isAnnotation(int)
     */
     ...
     * keyword is usually also present with the
     * {@link ByteCodeUtils#ACCESS_FINAL}
     * keyword. This will only be present in class access flags. Otherwise
     * it is ignored.
     *
     * @see ByteCodeUtils#isEnum(int)
     */
     ...
     * <ul>
     * <li>{@link ByteCodeUtils#NAME_PRIVATE}
     * <li>{@link ByteCodeUtils#NAME_PROTECTED}
     * </ul>
     */
    ...
    /**
     * The <code>String</code> representation of the
     * {@link ByteCodeUtils#ACCESS_PRIVATE}
     ...
     * The list of other visibility names are:
     * <ul>
     * <li>{@link ByteCodeUtils#NAME_PUBLIC}
     * <li>{@link ByteCodeUtils#NAME_PROTECTED}
     * </ul>
     */
    ...
    /**
     * The <code>String</code> representation of the
     * {@link ByteCodeUtils#ACCESS_PROTECTED}
     * flag. This will only be present in class, method and field
     * declarations. Only one of the visibility names should be present in
     * a valid access flags value.
     * <p>
    ...
    /**
     * The <code>String</code> representation of the
     * {@link ByteCodeUtils#ACCESS_STATIC} flag.
     */
    private static final String NAME_STATIC = "static";

    /**
     * The <code>String</code> representation of the
     * {@link ByteCodeUtils#ACCESS_FINAL} flag.
     */
    ...
    /**
     * The <code>String</code> representation of the
     * {@link ByteCodeUtils#ACCESS_SYNCHRONIZED}
     * flag.
     */
    ...
    /**
     * The <code>String</code> representation of the
     * {@link ByteCodeUtils#ACCESS_VOLATILE}
     * flag.
     */
    ...
    /**
     * The <code>String</code> representation of the
     * {@link ByteCodeUtils#ACCESS_TRANSIENT}
     * flag.
     */
    ...
    /**
     * The <code>String</code> representation of the
     * {@link ByteCodeUtils#ACCESS_NATIVE} flag.
     */
     ...
     * <ul>
     * <li>{@link ByteCodeUtils#ACCESS_ANNOTATION}
     * <li>{@link ByteCodeUtils#ACCESS_INTERFACE}
     * </ul>
     */
    ...
    /**
     * The <code>String</code> representation of the
     * {@link ByteCodeUtils#ACCESS_STRICT} flag.
     */
    ...
    /**
     * The <code>String</code> representation of the
     * {@link ByteCodeUtils#ACCESS_ENUM} flag.
     ...
     * <ul>
     * <li>{@link ByteCodeUtils#ACCESS_ANNOTATION}
     * <li>{@link ByteCodeUtils#ACCESS_ENUM}
     * <li>{@link ByteCodeUtils#ACCESS_INTERFACE}
     * </ul>
     */
     ...
     * <li> {@link ByteCodeUtils#ACCESS_PROTECTED}
     * <li> {@link ByteCodeUtils#ACCESS_PRIVATE}
     * <li> {@link ByteCodeUtils#ACCESS_ABSTRACT}
     * <li> {@link ByteCodeUtils#ACCESS_STATIC}
     * <li> {@link ByteCodeUtils#ACCESS_FINAL}
     * </ul>
     *
     * @see <a href="https://docs.oracle.com/javase/specs/jls/se8/html/jls-8.html#jls-8.1.1">jls-8.1.1</a>
     * @see ByteCodeUtils#getClassAccessNames(int)
     */
     ...
     * <li> {@link ByteCodeUtils#NAME_PROTECTED}
     * <li> {@link ByteCodeUtils#NAME_PRIVATE}
     * <li> {@link ByteCodeUtils#NAME_ABSTRACT}
     * <li> {@link ByteCodeUtils#NAME_STATIC}
     * <li> {@link ByteCodeUtils#NAME_FINAL}
     * </ul>
     *
     * @see <a href="https://docs.oracle.com/javase/specs/jls/se8/html/jls-8.html#jls-8.1.1">jls-8.1.1</a>
     * @see ByteCodeUtils#getClassAccessNames(int)
     ...
     * <li> {@link ByteCodeUtils#ACCESS_STATIC}
     * <li> {@link ByteCodeUtils#ACCESS_FINAL}
     * <li> {@link ByteCodeUtils#ACCESS_SYNCHRONIZED}
     * <li> {@link ByteCodeUtils#ACCESS_NATIVE}
     * <li> {@link ByteCodeUtils#ACCESS_STRICT}
     * </ul>
     *
     * @see <a href="https://docs.oracle.com/javase/specs/jls/se8/html/jls-8.html#jls-8.4.3">jls-8.4.3</a>
     * @see ByteCodeUtils#getMethodAccessNames(int)
     */
     ...
     * <li> {@link ByteCodeUtils#NAME_STATIC}
     * <li> {@link ByteCodeUtils#NAME_FINAL}
     * <li> {@link ByteCodeUtils#NAME_SYNCHRONIZED}
     * <li> {@link ByteCodeUtils#NAME_NATIVE}
     * <li> {@link ByteCodeUtils#NAME_STRICT}
     * </ul>
     *
     * @see <a href="https://docs.oracle.com/javase/specs/jls/se8/html/jls-8.html#jls-8.4.3">jls-8.4.3</a>
     * @see ByteCodeUtils#getMethodAccessNames(int)
     ...
     * <li> {@link ByteCodeUtils#ACCESS_STATIC}
     * <li> {@link ByteCodeUtils#ACCESS_FINAL}
     * <li> {@link ByteCodeUtils#ACCESS_TRANSIENT}
     * <li> {@link ByteCodeUtils#ACCESS_VOLATILE}
     * </ul>
     *
     * @see <a href="https://docs.oracle.com/javase/specs/jls/se8/html/jls-8.html#jls-8.3.1">jls-8.3.1</a>
     * @see ByteCodeUtils#getFieldAccessNames(int)
     */
     ...
     * <li> {@link ByteCodeUtils#NAME_STATIC}
     * <li> {@link ByteCodeUtils#NAME_FINAL}
     * <li> {@link ByteCodeUtils#NAME_TRANSIENT}
     * <li> {@link ByteCodeUtils#NAME_VOLATILE}
     * </ul>
     *
     * @see <a href="https://docs.oracle.com/javase/specs/jls/se8/html/jls-8.html#jls-8.3.1">jls-8.3.1</a>
     * @see ByteCodeUtils#getFieldAccessNames(int)
     ...
     * <ul>
     * <li> {@link ByteCodeUtils#isPrivate(int)}
     * <li> {@link ByteCodeUtils#isProtected(int)}
     * </ul>
     *
     ...
     * <code>public</code> visibility.
     * @see ByteCodeUtils#ACCESS_PUBLIC
     */
     ...
     * The other visibility checks are:
     * <ul>
     * <li> {@link ByteCodeUtils#isPublic(int)}
     * <li> {@link ByteCodeUtils#isProtected(int)}
     * </ul>
     *
     * @param access The access flags for the class, method or field.
     * @return <code>true</code> if and only if the access flags indicate
     * <code>private</code> visibility.
     * @see ByteCodeUtils#ACCESS_PRIVATE
     */
     ...
     * @return <code>true</code> if and only if the access flags indicate
     * <code>protected</code> visibility.
     * @see ByteCodeUtils#ACCESS_PROTECTED
     */
     ...
     * @see ByteCodeUtils#ACCESS_STATIC
     */
     ...
     * @see ByteCodeUtils#ACCESS_FINAL
     */
     ...
     * @see ByteCodeUtils#ACCESS_SUPER
     */
     ...
     * @see ByteCodeUtils#ACCESS_SYNCHRONIZED
     */
     ...
     * @see ByteCodeUtils#ACCESS_BRIDGE
     */
     ...
     * @see ByteCodeUtils#ACCESS_VOLATILE
     */
     ...
     * @see ByteCodeUtils#ACCESS_TRANSIENT
     */
     ...
     * @see ByteCodeUtils#ACCESS_VARARGS
     */
     ...
     * @see ByteCodeUtils#ACCESS_NATIVE
     */
     ...
     * <ul>
     * <li> {@link ByteCodeUtils#isAnnotation(int)}
     * <li> {@link ByteCodeUtils#isEnum(int)}
     * </ul>
     *
     * @param access The access flags for the class.
     * @return <code>true</code> if and only if the access flags indicate
     * the class type is an <code>interface</code>.
     * @see ByteCodeUtils#ACCESS_INTERFACE
     */
     ...
     * @see ByteCodeUtils#ACCESS_STRICT
     */
     ...
     * @see ByteCodeUtils#ACCESS_SYNTHETIC
     */
     ...
     * The other class type checks are:
     * <ul>
     * <li> {@link ByteCodeUtils#isInterface(int)}
     * <li> {@link ByteCodeUtils#isEnum(int)}
     * </ul>
     *
     * @param access The access flags for the class.
     ...
     * @see ByteCodeUtils#ACCESS_ANNOTATION
     */
