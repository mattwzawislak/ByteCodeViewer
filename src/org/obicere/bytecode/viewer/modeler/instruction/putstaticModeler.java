 ...
 * @author Obicere
 */
public class putstaticModeler extends InstructionModeler<DefaultPutStatic> {
    @Override
    protected void modelValue(final DefaultPutStatic element, final DocumentBuilder builder) {
